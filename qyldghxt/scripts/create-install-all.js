...
const serverExe = path.join(releaseRoot, 'server', `Server-Setup-${version}.exe`)
const clientExe = path.join(releaseRoot, `Client-Setup-${version}.exe`)
...
const bat = [
  ...
  'sc stop QYLDGHXTServer >nul 2>&1',
